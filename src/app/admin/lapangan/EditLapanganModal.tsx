    ...
    <>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
          <div className="bg-[#1F2937] border border-[#374151] p-6 md:p-8 rounded-2xl w-full max-w-lg shadow-2xl relative max-h-[90vh] overflow-y-auto">
            ...
            <h2 className="text-xl md:text-2xl font-bold text-white mb-6 mt-2 md:mt-0">Edit Lapangan</h2>
